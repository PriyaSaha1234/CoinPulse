...
const CandlestickChart = ({
                              children, data, coinID, height =360, initialPeriod='daily'}: CandlestickChartProps) => {
    ...
    const fetchOHLCData = async (selectedPeriod: Period) => {
        try {
            ...
            console.log(selectedPeriod, newData?.length);

            setohlcData(newData ?? []);
        }
        catch (e) {
            console.error('Failed period:', selectedPeriod);
            console.error(e);
        }
    }
